<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BeanBag24.aspx.cs" Inherits="WebApplication1.BeanBag_2.BeanBag24" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="row">
            <div class="col2">
                <asp:Image id="img" runat="server" ImageUrl="~/Images/BeanBags/beanbag5%204.jpg"></asp:Image>
            </div>
            <div class="col2">
                <h1>
                ...
                <div class="options">
                    ...
                    &nbsp;
                            <asp:ImageButton ID="ImageButton4" class="imgbtn" runat="server"
                                ImageUrl="~/Images/BeanBags/beanbag5 4.jpg"  />
                </div>
                <div class="quantity">
                    <h6>QUANTITY</h6>
