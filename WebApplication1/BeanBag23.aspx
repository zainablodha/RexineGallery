<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BeanBag23.aspx.cs" Inherits="WebApplication1.BeanBag_2.BeanBag23" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="row">
            <div class="col2">
                <asp:Image id="img" runat="server" ImageUrl="~/Images/BeanBags/beanbag5%203.jpg"></asp:Image>
            </div>
            <div class="col2">
                <h1>
                ...
                <div class="options">
                    ...
                    &nbsp;
                            <asp:ImageButton ID="ImageButton3" class="imgbtn" runat="server"
                                ImageUrl="~/Images/BeanBags/beanbag5 3.jpg"  />
                    &nbsp;
