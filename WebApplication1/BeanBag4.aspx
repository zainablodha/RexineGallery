<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BeanBag4.aspx.cs" Inherits="WebApplication1.BeanBag4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="row">
            <div class="col2">
                <asp:Image id="img" runat="server" ImageUrl="~/Images/BeanBags/beanbag8 10.jpg"></asp:Image>
            </div>
            <div class="col2">
                <h1>
