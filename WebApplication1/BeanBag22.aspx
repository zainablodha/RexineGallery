<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BeanBag22.aspx.cs" Inherits="WebApplication1.BeanBag_2.BeanBag22" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="row">
            <div class="col2">
                <asp:Image id="img" runat="server" ImageUrl="~/Images/BeanBags/beanbag5%202.jpg"></asp:Image>
            </div>
            <div class="col2">
                <h1>
                ...
                <div class="options">
                    ...
                    <asp:ImageButton ID="ImageButton5" class="imgbtn" runat="server"
                        ImageUrl="~/Images/BeanBags/beanbag5.jpg" OnClick="ImageButton5_Click"/>
                    &nbsp;
                    ...
                    &nbsp;
                            <asp:ImageButton ID="ImageButton2" class="imgbtn" runat="server"
                                ImageUrl="~/Images/BeanBags/beanbag5 2.jpg" />
                    &nbsp;
                ...
                <div class="quantity">
                    <h6>QUANTITY</h6>
                    <asp:TextBox ID="q" class="" runat="server" AutoPostBack="True" TextMode="number" min="1" max="10" Text="1" OnTextChanged="q_TextChanged"></asp:TextBox>
