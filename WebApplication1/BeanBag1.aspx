    ...
    <body>
        <div class="container">
            <div class="row">
                ...
                <div class="col2">
                    <h1>
                        <asp:Label ID="Bbname" runat="server"></asp:Label></h1>
                    <div class="price">
                    ...
                    <div class="options">
                        <h6>OPTIONS</h6>
                        <br />
                        <asp:ImageButton ID="ImageButton5" class="imgbtn" runat="server" ImageUrl="~/Images/BeanBags/beanbag2.jpg" />&nbsp;
                         <asp:ImageButton ID="ImageButton1" class="imgbtn" runat="server" ImageUrl="~/Images/BeanBags/beanbag2 6.jpg" OnClick="ImageButton1_Click" />&nbsp;
